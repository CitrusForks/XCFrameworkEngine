...
#if !defined(XCGRAPHICS_DX12) && !defined(XCGRAPHICS_GL)
...
#pragma pack(pop)
    ...
    {
        #if defined(_DEBUG_DISABLE) || defined(PROFILE)
                                      ...
                                      )
{
    ...
    // open the file
#if (_WIN32_WINNT >= 0x06021 /*_WIN32_WINNT_WIN8*/)
...
static HRESULT CreateD3DResources( _In_ ID3D11Device* d3dDevice,
                                   ...
                                   _Outptr_opt_result_nullonfailure_ ID3D11Resource** texture,
                                   _Outptr_opt_result_nullonfailure_ ID3D11ShaderResourceView** textureView )
{
    if( texture != nullptr )
    {
        *texture = nullptr;
                                             ...
                                             ID3D11ShaderResourceView** textureView )
{
    ...
    if (texture != 0 || textureView != 0)
    {
        ...
        XSF_ASSERT( 0 < WideCharToMultiByte( CP_ACP,
