...
namespace GameState
{
    ...
    void RunningState::Init()
    {
        ...
        //Add the physics debug feature
        DebugInterface& debugInterface = SystemLocator::GetInstance()->RequestSystem<DebugInterface>("DebugInterface");
        debugInterface.AddDebugFeature("DebugPhysicsOBB");
    #endif
    ...
    {
    #if defined(DEBUG_PHYSICS_OBB)
        //Remove the physics debug feature
        DebugInterface& debugInterface = SystemLocator::GetInstance()->RequestSystem<DebugInterface>("DebugInterface");
        debugInterface.RemoveDebugFeature("DebugPhysicsOBB");
    #endif
