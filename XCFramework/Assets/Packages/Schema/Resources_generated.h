...
struct FBResources FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<FBCubeTexture3D>> *FBCubeTexture3DS() const { return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<FBCubeTexture3D>> *>(10); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<flatbuffers::uoffset_t>(verifier, 10 /* FBCubeTexture3DS */) &&
...
struct FBResourcesBuilder {
  ...
  void add_FBCubeTexture3DS(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<FBCubeTexture3D>>> FBCubeTexture3DS) { fbb_.AddOffset(10, FBCubeTexture3DS); }
  ...
  flatbuffers::Offset<FBResources> Finish() {
    auto o = flatbuffers::Offset<FBResources>(fbb_.EndTable(start_, 4));
    return o;
  }
};
