...
struct FBDoor FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::String *Texture2DResourceName() const { return GetPointer<const flatbuffers::String *>(8); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<Vec4>(verifier, 4 /* Position */) &&
           VerifyField<flatbuffers::uoffset_t>(verifier, 6 /* XCMeshResourceName */) &&
           verifier.Verify(XCMeshResourceName()) &&
           VerifyField<flatbuffers::uoffset_t>(verifier, 8 /* Texture2DResourceName */) &&
           verifier.Verify(Texture2DResourceName()) &&
           verifier.EndTable();
  }
};
...
struct FBDoorBuilder {
  ...
  void add_Texture2DResourceName(flatbuffers::Offset<flatbuffers::String> Texture2DResourceName) { fbb_.AddOffset(8, Texture2DResourceName); }
