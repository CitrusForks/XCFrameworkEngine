...
enum SHADERTYPE {
  ...
  SHADERTYPE_REFELECTED_LIGHTTEXTURE = 6,
  SHADERTYPE_MAX = 7
};

inline const char **EnumNamesSHADERTYPE() {
  static const char *names[] = { "DEFAULT", "COLORTECH", "LIGHTTEXTURE", "TERRIANMULTITEXTURE", "SIMPLECUBEMAP", "SKINNEDCHARACTER", "REFELECTED_LIGHTTEXTURE", "MAX", nullptr };
  return names;
}
