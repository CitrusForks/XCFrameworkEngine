...
print("Building C++ Win32 Project XCGraphics")
	...
	filter "configurations:Debug"
		...
		libdirs { "$(ProjectDir)bin/$(Configuration)/", "$(ProjectDir)Libs", "$(ProjectDir)Libs/DirectXTex/$(Configuration)/", "$(ProjectDir)Libs/flatbuffers/$(Configuration)", "$(ProjectDir)Libs/Assimp/$(Configuration)", "$(ProjectDir)Libs/AdobeFBX/x86/$(Configuration)/" }
