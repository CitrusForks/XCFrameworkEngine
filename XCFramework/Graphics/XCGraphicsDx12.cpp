...
XCGraphicsDx12::XCGraphicsDx12(void)
...
void XCGraphicsDx12::Init(HWND _mainWnd, i32 _width, i32 _height, bool _enable4xMsaa)
{
...
#pragma region Debug
void XCGraphicsDx12::DebugTestGraphicsPipeline()
{
...
void XCGraphicsDx12::SetupDepthView()
{
...
void XCGraphicsDx12::CreateDescriptorHeaps()
{
...
void XCGraphicsDx12::CreateGPUResourceSystem()
{
    //GPU Resource system
    SystemContainer& container = SystemLocator::GetInstance()->GetSystemContainer();
...
void XCGraphicsDx12::SetupRenderQuad()
{
...
void XCGraphicsDx12::Update(f32 dt)
{
}
...
void XCGraphicsDx12::SetRenderableTargets(ID3DDeviceContext& context, const std::vector<RenderTargetsType>& types)
{
...
void XCGraphicsDx12::WaitForPreviousFrameCompletion()
{
...
void XCGraphicsDx12::OnResize(i32 _width, i32 _height)
{
    if (m_initDone)
    {
