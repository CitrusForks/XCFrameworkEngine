...
ID3D12RootSignature& PSODx12::GetRootSignature(RasterType type)
{ 
    return *m_psos[type].m_rootSignature; 
}

bool PSODx12::CreateRootSignature(ID3DDevice& device, void* bufferPtr, u32 bufferSize, RasterType type)
{
...
void PSODx12::GenerateDefaultPSO(PSODx12* inPso, PSODesc& desc)
{
...
void PSODx12::CreateGraphicPSO(ID3DDevice& device, RasterType type)
{
...
void PSODx12::SetGraphicsPipelineState(ID3DDeviceContext& context, RasterType rasterType)
{
    //Set the pso
