...
public:
    ThirdPersonCamera();
    ThirdPersonCamera(DirectInput& input, IActor* actor, XCVecIntrinsic4 _pos, XCVecIntrinsic4 _target, XCVecIntrinsic4 _up, float _aspectRatio, float _fov, float _near, float _far);
