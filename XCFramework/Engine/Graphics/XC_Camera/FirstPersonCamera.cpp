...
FirstPersonCamera::FirstPersonCamera(DirectInput& directInput, XCVecIntrinsic4 pos, XCVecIntrinsic4 target, XCVecIntrinsic4 up, float aspectRatio, float fov, float nearPlane, float farPlane)
    : ICamera(directInput, pos, target, up, aspectRatio, fov, nearPlane, farPlane)
{
    m_isSetLockY = false;
    m_lockYUnit = 0.0f;
